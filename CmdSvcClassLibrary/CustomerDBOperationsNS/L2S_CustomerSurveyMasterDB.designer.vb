...
Partial Public Class L2S_CustomerSurveyMasterDBDataContext
  ...
  #End Region
	...
	Public Sub New()
		MyBase.New(Global.CustomerDBOperationsNS.My.MySettings.Default.ExxonSurveyMasterConnectionString2, mappingSource)
		OnCreated
	End Sub
...
Partial Public Class LoginSurveyPrivilege
    ...
    Partial Private Sub OnSurveyIDChanged()
    End Sub
    Partial Private Sub OnPrivilegeIDChanging(value As Integer)
    End Sub
...
Partial Public Class SurveyDataStore
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_DatabaseName", DbType:="VarChar(50) NOT NULL", CanBeNull:=false)>  _
