...
Public Interface IResultsSvc
   ...
   Function TellMeYouWork() As String
    ...
    <OperationContract()> _
    Function Save_ResultsFilters(ByVal _SurveyID As Integer, ByVal _ListofResultsFilter As List(Of ResultsFilterModelObject)) As Boolean
...
Public Class ResultsProviderSummaryObject
    ...
    Public Shared Function ToSmallRsltDetails(ByVal _listofResultsDetail As List(Of ResultsDetail)) As List(Of SmallRsltDetail)
        Dim rslt = New List(Of SmallRsltDetail)
        Dim q = From rd In _listofResultsDetail _
