...
<System.Data.Linq.Mapping.DatabaseAttribute(Name:="Survey4DataStore")>  _
...
<Table(Name:="dbo.PageContentModel")>  _
Partial Public Class PageContentModel
	...
	<Column(Storage:="_PageContentModelID", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	...
	<Column(Storage:="_PgItemModelID", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_HostingControlSize", DbType:="VarChar(100) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_Model", DbType:="VarChar(MAX)")>  _
...
<Table(Name:="dbo.PageContentElement")>  _
Partial Public Class PageContentElement
	...
	<Column(Storage:="_PageContentElementID", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	...
	<Column(Storage:="_PageContentModelID", DbType:="Int NOT NULL")>  _
	Public Property PageContentModelID() As Integer
		Get
			Return Me._PageContentModelID
		End Get
	...
	<Column(Storage:="_PresenterTypeName", DbType:="VarChar(50) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_ViewModel", DbType:="VarChar(MAX)")>  _
...
<Table(Name:="dbo.QuestOptionItemModel")>  _
Partial Public Class QuestOptionItemModel
	...
	<Column(Storage:="_QuestOptionItemModelID", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	...
	<Column(Storage:="_QuestOptionSetModelID", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_SelectorConfiguration", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_OptionItemObject", DbType:="VarChar(MAX)")>  _
	...
	<Column(Storage:="_QOptionItemText", DbType:="VarChar(50) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_OptionIsSelected", DbType:="Bit NOT NULL")>  _
...
<Table(Name:="dbo.QuestionOptionSetModel")>  _
Partial Public Class QuestionOptionSetModel
	...
	<Column(Storage:="_QuestOptionSetModelID", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	Public Property QuestOptionSetModelID() As Integer
		Get
			Return Me._QuestOptionSetModelID
		End Get
	...
	<Column(Storage:="_PageContentElementID", DbType:="Int NOT NULL")>  _
	Public Property PageContentElementID() As Integer
		Get
			Return Me._PageContentElementID
		End Get
	...
	<Column(Storage:="_LayoutConfiguration", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_UniGridColumns", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_UniGridRows", DbType:="Int NOT NULL")>  _
...
Partial Public Class PgItemModel
	...
	<Column(Storage:="_PageItemModelID", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	...
	<Column(Storage:="_SurveyName", DbType:="VarChar(50) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_Property1Value", DbType:="VarChar(50) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_PageNumber", DbType:="VarChar(3) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_PageOptions", DbType:="VarChar(50) NOT NULL", CanBeNull:=false)>  _
